...
2. [Линейные алгоритмы классификации](#Линейные-алгоритмы-классификации)
    1. [Метод опорных векторов](#Метод-опорных-векторов)
...
***Преимущества SVM***
    ...
    3. Если сводится к задаче квадратичного программирования, то имеет одно решение и множество эффективных способов решения.
