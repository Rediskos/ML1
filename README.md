...
![ХДЕ?????](LDF/ldf_map.png?raw=true "Optional Title")
...
![ХДЕ?????](SGD/SGD1.png?raw=true "Optional Title")
...
![ХДЕ?????](SGD/SGD3.png?raw=true "Optional Title")
![ХДЕ?????](SGD/SGD4.png?raw=true "Optional Title")

Делать шаг можно также не учитывая всю выборку сразу, а отдельно по каждому преценденту.
![ХДЕ?????](SGD/SGD5.png?raw=true "Optional Title")
